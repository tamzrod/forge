...
func main() {
	...
	log.Println("  Simulation Models (external world)")
	log.Println("          ↓")
	log.Println("  Weather Station Firmware (samples models)")
	log.Println("          ↓")
	log.Println("  Device Memory (firmware-owned)")
	log.Println("          ↓")
	log.Println("  Raw Ingest Interface (serializes memory)")
	log.Println()
